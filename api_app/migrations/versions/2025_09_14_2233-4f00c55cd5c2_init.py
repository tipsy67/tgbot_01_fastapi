...
Revision ID: 4f00c55cd5c2
Revises:
Create Date: 2025-09-14 22:33:42.512435
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['initiator_id'], ['users.id'], name=op.f('fk_tickets_initiator_id_users')
        ),
        sa.ForeignKeyConstraint(
            ['prize_id'], ['prizes.id'], name=op.f('fk_tickets_prize_id_prizes')
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f('ix_tickets_initiator_id'), 'tickets', ['initiator_id'], unique=False
    )
